...
const clientstart = async() => {
    ...
    if (config().status.terminal && !sock.authState.creds.registered) {
        const phoneNumber = await question('enter your WhatsApp number, starting with 256:\nnumber WhatsApp: ');
        ...
        if (connection === 'open') {
            ...
            sock.sendMessage(botNumber, {
                text:
                    ...
                    `> ⚡ Prefix: [ . ]\n` +
                    `> 🚀 Mode: ${sock.public ? 'private' : 'Self'}\n` +
                    `> 🤖 Version: 1.0.0\n` +
                    `> 👑 Owner: ĎÁŃŤĔ\n\n` +
                    `✅ Bot connected successfully\n` +
                    `📢 JOIN my whatsapp channel https://whatsapp.com/channel/0029VbA9N977YSd48J5MRp1C`,
                contextInfo: {
                    forwardingScore: 1,
                    isForwarded: true,
                    externalAdReply: {
                        ...
                        sourceUrl: "https://whatsapp.com/channel/0029VbA9N977YSd48J5MRp1C",
                        mediaType: 1,
